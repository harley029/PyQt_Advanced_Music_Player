...
"}")
        ...
        self.about_btn = QtWidgets.QPushButton(self.title_frame)
        self.about_btn.setGeometry(QtCore.QRect(737, 8, 31, 32))
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/img/utils/images/detail.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"color: rgb(79, 208, 178);")
        ...
        self.label_5.setGeometry(QtCore.QRect(10, 42, 41, 21))
        font = QtGui.QFont()
...
"color: rgb(79, 208, 178);")
        ...
        self.current_song_title = QtWidgets.QLabel(self.frame_2)
        self.current_song_title.setGeometry(QtCore.QRect(60, 42, 231, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.current_song_title.setFont(font)
        self.current_song_title.setStyleSheet("background-color: rgba(0, 0, 0,0);\n"
"color: rgb(255, 255, 255);")
        self.current_song_title.setObjectName("current_song_title")
        ...
        self.add_to_fav_btn.setToolTip("")
...
"}")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/img/utils/images/like.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_to_fav_btn.setIcon(icon4)
        ...
        self.add_to_playlist_btn.setAutoFillBackground(False)
...
"}")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/img/utils/images/music_list.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_to_playlist_btn.setIcon(icon5)
        ...
        self.label_7.setGeometry(QtCore.QRect(10, 62, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"color: rgb(79, 208, 178);")
        ...
        self.current_song_artist = QtWidgets.QLabel(self.frame_2)
        self.current_song_artist.setGeometry(QtCore.QRect(60, 62, 231, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.current_song_artist.setFont(font)
        self.current_song_artist.setStyleSheet("background-color: rgba(0, 0, 0,0);\n"
"color: rgb(255, 255, 255);")
        self.current_song_artist.setObjectName("current_song_artist")
        self.label_8 = QtWidgets.QLabel(self.frame_2)
        self.label_8.setGeometry(QtCore.QRect(10, 82, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"color: rgb(79, 208, 178);")
        ...
        self.current_song_album = QtWidgets.QLabel(self.frame_2)
        self.current_song_album.setGeometry(QtCore.QRect(60, 82, 231, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.current_song_album.setFont(font)
        self.current_song_album.setStyleSheet("background-color: rgba(0, 0, 0,0);\n"
"color: rgb(255, 255, 255);")
        self.current_song_album.setObjectName("current_song_album")
        self.label_11 = QtWidgets.QLabel(self.frame_2)
        self.label_11.setGeometry(QtCore.QRect(10, 102, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"color: rgb(79, 208, 178);")
        ...
        self.current_song_duration = QtWidgets.QLabel(self.frame_2)
        self.current_song_duration.setGeometry(QtCore.QRect(70, 102, 221, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.current_song_duration.setFont(font)
        self.current_song_duration.setStyleSheet("background-color: rgba(0, 0, 0,0);\n"
"color: rgb(255, 255, 255);")
        self.current_song_duration.setObjectName("current_song_duration")
        ...
        self.frame_3.setGeometry(QtCore.QRect(10, 470, 861, 81))
...
"")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/img/utils/images/pase.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/img/utils/images/play.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/img/utils/images/stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/img/utils/images/pre.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.previous_btn.setIcon(icon9)
...
"")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/img/utils/images/next.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/img/utils/images/loop-one.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.loop_one_btn.setIcon(icon11)
...
"")
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/img/utils/images/play-random.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.shuffle_songs_btn.setIcon(icon12)
...
"border-radius:15px;")
        ...
        self.frame_5.setGeometry(QtCore.QRect(12, 12, 111, 31))
        self.frame_5.setStyleSheet("background-color: rgba(255, 255, 255, 0);")
        self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_5.setObjectName("frame_5")
        self.frame_6 = QtWidgets.QFrame(self.frame_5)
        self.frame_6.setGeometry(QtCore.QRect(128, 0, 24, 24))
        ...
        self.label_6.setGeometry(QtCore.QRect(18, 8, 91, 18))
        font = QtGui.QFont()
        ...
        self.loaded_songs_listWidget.setGeometry(QtCore.QRect(9, 60, 531, 291))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.loaded_songs_listWidget.setToolTip("")
...
"}")
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/img/utils/images/clear.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.delete_selected_btn.setIcon(icon14)
...
"}")
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/img/utils/images/addFromLocal.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_songs_btn.setIcon(icon15)
        ...
        self.label_9.setGeometry(QtCore.QRect(30, 4, 131, 50))
        font = QtGui.QFont()
        font.setPointSize(17)
        font.setBold(True)
        font.setWeight(75)
...
"background-color: rgab(255, 255, 255, 0);")
        ...
        self.load_selected_playlist_btn.setGeometry(QtCore.QRect(400, 16, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.load_selected_playlist_btn.setStyleSheet("QPushButton{\n"
"    background-color: rgb(0, 255, 127);\n"
"    border-radius:15px;\n"
"}\n"
"\n"
...
"}")
        ...
        self.playlists_listWidget.setGeometry(QtCore.QRect(10, 60, 531, 251))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.new_playlist_btn.setGeometry(QtCore.QRect(47, 320, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.remove_selected_playlist_btn.setGeometry(QtCore.QRect(180, 320, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.remove_all_playlists_btn.setGeometry(QtCore.QRect(380, 320, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.label_10.setGeometry(QtCore.QRect(30, 4, 131, 50))
        font = QtGui.QFont()
        font.setPointSize(17)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.delete_selected_favourite_btn.setIcon(icon14)
...
"}")
        ...
        self.delete_all_favourites_btn.setIcon(icon13)
...
"}")
        ...
        self.playlists_btn.setStyleSheet("QPushButton{\n"
"    background-color: rgb(0, 255, 127);\n"
"    border-radius:15px;\n"
"}\n"
"\n"
...
"}")
        ...
        self.volume_label.setGeometry(QtCore.QRect(130, 376, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.actionPause_Unpause.setIcon(icon7)
        ...
        self.actionAdd_Selected_to_Favourites.setIcon(icon4)
        ...
        self.actionAdd_all_to_Favouries.setIcon(icon4)
        ...
        self.actionLoad_Selected_Playlist.setIcon(icon5)
        ...
        self.actionDelete_Selected_Playlist.setIcon(icon14)
        ...
        self.actionDelete_All_Playlists.setIcon(icon13)
        ...
        self.actionRemove_Selected_Favourite.setIcon(icon14)
        ...
        self.actionRemove_All_Favourites.setIcon(icon13)
        ...
        self.actionCrete_Playlist = QtWidgets.QAction(MusicApp)
        self.actionCrete_Playlist.setIcon(icon17)
        self.actionCrete_Playlist.setObjectName("actionCrete_Playlist")
        self.actionAbout_Song = QtWidgets.QAction(MusicApp)
        self.actionAbout_Song.setIcon(icon3)
        self.actionAbout_Song.setObjectName("actionAbout_Song")
    ...
    def retranslateUi(self, MusicApp):
        ...
        self.label.setText(_translate("MusicApp", "QT Beets"))
        self.label_3.setText(_translate("MusicApp", "Currently Playing"))
        self.label_5.setText(_translate("MusicApp", "Title:"))
        self.current_song_title.setText(_translate("MusicApp", "Song title goes here"))
        ...
        self.label_7.setText(_translate("MusicApp", "Artist:"))
        self.current_song_artist.setText(_translate("MusicApp", "Artist name goes here"))
        self.label_8.setText(_translate("MusicApp", "Album:"))
        self.current_song_album.setText(_translate("MusicApp", "Albun title goes here"))
        self.label_11.setText(_translate("MusicApp", "Duration:"))
        self.current_song_duration.setText(_translate("MusicApp", "Song duration goes here"))
        ...
        self.actionCrete_Playlist.setText(_translate("MusicApp", "Create Playlist"))
        self.actionCrete_Playlist.setToolTip(_translate("MusicApp", "Add selected song to Favourites"))
        self.actionAbout_Song.setText(_translate("MusicApp", "About Song"))
        self.actionAbout_Song.setToolTip(_translate("MusicApp", "About song"))
import res_rc

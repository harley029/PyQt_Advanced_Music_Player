...
class PlaylistContextMenuManager:
    ...
    def setup_menu(self):
        ...
        self.create_new_playlist_command = cmd.NewPlaylistCommand(
            self.playlist_manager, self.parent
        )
        self.del_sel_pl_command = cmd.DeletePlaylistCommand(
            self.playlist_manager, self.parent
        )
        self.del_all_pl_command = cmd.DeleteAllPlaylistCommand(
            self.playlist_manager, self.parent
        )
        ...
        actionLoad_Selected_Playlist = CommandAction(
            QIcon(":/img/utils/images/music_list.png"),
            msg.CTX_LOAD_LST,
            self.parent,
            self.load_playlist_command,
        )
        ...
        actionCreate_New_Playlist = CommandAction(
            QIcon(":/img/utils/images/music_list.png"),
            msg.CTX_NEW_LST,
            self.parent,
        ...
        actionDelete_Selected_Playlist = CommandAction(
            QIcon(":/img/utils/images/clear.png"),
            msg.CTX_DEL_SEL_LST,
            self.parent,
            self.del_sel_pl_command,
        )
        actionDelete_All_Playlists = CommandAction(
            QIcon(":/img/utils/images/remove.png"),
            msg.CTX_DEL_ALL_LST,
            self.parent,
            self.del_all_pl_command,
        )
...
class FavouritesContextMenuManager:
    ...
    def setup_menu(self):
        ...
        self.del_all_favourites_command = cmd.DeleteAllFavouriteCommand(
            self.favourites_manager
        )
        ...
        actionRemove_Selected_Favourite = CommandAction(
            QIcon(":/img/utils/images/clear.png"),
            msg.CTX_DEL_SEL,
            self.parent,
            self.del_selected_fav_command,
        )
        actionRemove_All_Favourites = CommandAction(
            QIcon(":/img/utils/images/remove.png"),
            msg.CTX_DEL_ALL,
            self.parent,
            self.del_all_favourites_command,
        )
...
class SongsListContextMenuManager:
    ...
    def setup_menu(self):
        ...
        self.sel_to_fav_command = cmd.SelectedToFavouritesCommand(
            self.favourites_manager
        )
        self.all_to_fav_command = cmd.AllToFavouritesCommand(self.favourites_manager)
        self.sel_to_pl_command = cmd.SelectedToPlaylistCommand(
            self.playlist_manager, self.parent
        )
        self.all_to_pl_command = cmd.AllToPlaylistCommand(
            self.playlist_manager, self.parent
        )
        ...
        actionPlay = CommandAction(
            QIcon(":/img/utils/images/pase.png"),
            msg.CTX_PLAY,
            self.parent,
            self.play_command,
        )
        actionPause_Unpause = CommandAction(
            QIcon(":/img/utils/images/play.png"),
            msg.CTX_PAUSE,
            self.parent,
            self.pause_command,
        )
        actionNext = CommandAction(
            QIcon(":/img/utils/images/next.png"),
            msg.CTX_NEXT,
            self.parent,
            self.next_command,
        )
        actionPrevious = CommandAction(
            QIcon(":/img/utils/images/pre.png"),
            msg.CTX_PREVS,
            self.parent,
            self.previous_command,
        )
        actionStop = CommandAction(
            QIcon(":/img/utils/images/stop.png"),
            msg.CTX_STOP,
            self.parent,
            self.stop_command,
        )
        ...
        actionAdd_Selected_to_Favourites = CommandAction(
            QIcon(":/img/utils/images/like.png"),
            msg.CTX_ADD_TO_FAV,
            self.parent,
            self.sel_to_fav_command,
        )
        actionAdd_all_to_Favourites = CommandAction(
            QIcon(":/img/utils/images/like.png"),
            msg.CTX_ADD_ALL_TO_FAV,
            self.parent,
            self.all_to_fav_command,
        )
        ...
        actionSave_Selected_to_a_Playlist = CommandAction(
            QIcon(":/img/utils/images/MusicListItem.png"),
            msg.CTX_ADD_TO_LST,
            self.parent,
            self.sel_to_pl_command,
        )
        actionSave_all_to_a_Playlist = CommandAction(
            QIcon(":/img/utils/images/MusicListItem.png"),
            msg.CTX_ADD_ALL_TO_LST,
            self.parent,
            self.all_to_pl_command,
        )

...
class ContextMenuManager:
    ...
    def setup_favourite_menu(self):
        ...
        actionRemove_Selected_Favourite=CommandAction(QIcon(":/img/utils/images/clear.png"), "Удалить выбранное", self.parent, self.del_selected_fav_command)
        ctionRemove_All_Favourites=CommandAction(QIcon(":/img/utils/images/remove.png"), "Удалить всё", self.parent, self.del_all_favourites_command)
    ...
    def setup_playlist_menu(self):
        ...
        actionLoad_Selected_Playlist=CommandAction(QIcon(":/img/utils/images/music_list.png"), "Загрузить плейлист", self.parent, self.load_playlist_command)
        menu.addAction(actionLoad_Selected_Playlist)
        separator = QAction(self.parent)
        separator.setSeparator(True)
        menu.addAction(separator)

        actionCreate_New_Playlist=CommandAction(QIcon(":/img/utils/images/music_list.png"), "Создать новый плейлист", self.parent, self.create_new_playlist_command)
        menu.addAction(actionCreate_New_Playlist)
        separator1 = QAction(self.parent)
        separator1.setSeparator(True)
        menu.addAction(separator1)

        actionDelete_Selected_Playlist=CommandAction(QIcon(":/img/utils/images/clear.png"), "Удалить выбранный плейлист", self.parent, self.del_sel_pl_command)
        actionDelete_All_Playlists=CommandAction(QIcon(":/img/utils/images/remove.png"), "Удалить все плейлисты", self.parent, self.del_all_pl_command)
    ...
    def setup_song_menu(self):
        ...
        actionPlay = CommandAction(QIcon(":/img/utils/images/pase.png"), "Воспроизвести", self.parent, self.play_command)
        actionPause_Unpause = CommandAction(QIcon(":/img/utils/images/play.png"), "Пауза / Продолжить", self.parent, self.pause_command)
        actionNext = CommandAction(QIcon(":/img/utils/images/next.png"), "Следующая", self.parent, self.next_command)
        actionPrevious = CommandAction(QIcon(":/img/utils/images/pre.png"), "Предыдущая", self.parent, self.previous_command)
        actionStop = CommandAction(QIcon(":/img/utils/images/stop.png"), "Остановить", self.parent, self.stop_command)
        ...
        actionAdd_Selected_to_Favourites=CommandAction(QIcon(":/img/utils/images/like.png"), "Добавить в избранное", self.parent, self.sel_to_fav_command)
        actionAdd_all_to_Favourites=CommandAction(QIcon(":/img/utils/images/like.png"), "Добавить все в избранное", self.parent, self.all_to_fav_command)
        ...
        actionSave_Selected_to_a_Playlist=CommandAction(QIcon(":/img/utils/images/MusicListItem.png"), "Добавить в плейлист", self.parent, self.sel_to_pl_command)
        actionSave_all_to_a_Playlist=CommandAction(QIcon(":/img/utils/images/MusicListItem.png"), "Добавить все в плейлист", self.parent, self.all_to_pl_command)
